...
Todos os artefatos foram organizados dentro de \texttt{rlhf-project/}. A implementação utilizou principalmente as bibliotecas Hugging Face \texttt{datasets} e \texttt{transformers}, que fornecem as abstrações de \texttt{DatasetDict}, tokenização, carregamento de modelos e treinamento usadas neste trabalho \cite{lhoest2021datasets,wolf2020transformers}. Os principais scripts gerados foram:
